...
int main(void) {
	...
	char key[] = "x0x0x0x0";
	char sVirtualProtect[] = { 0x2e, 0x59, 0xa, 0x44, 0xd, 0x51, 0x14, 0x60, 0xa, 0x5f, 0xc, 0x55, 0x1b, 0x44 };
	...
	DecryptXOR((char *) sVirtualProtect, strlen(sVirtualProtect), key, sizeof(key));
